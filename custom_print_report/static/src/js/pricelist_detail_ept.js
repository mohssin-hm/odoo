odoo.define('custom_print_report.pricelist_detail_script',function(require){
'use strict';
...
VariantMixin._onChangeCombinationStock = function (ev, $parent, combination) {
    ...
    if(combination.product_details.length > 0)
    {
        $("#product_details_ept").empty()
        $("#product_details_ept").append(combination.product_details)
    }
